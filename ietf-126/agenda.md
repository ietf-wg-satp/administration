...
- 5m - SATP document status - Chairs and Various Authors
- 20m - SATP Error Handling  - Martin Gfeller
...
### Other documents
- [WG datatracker list](https://datatracker.ietf.org/group/satp/documents/)
